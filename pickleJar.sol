...
contract PickleJar is ERC20 {
  ...
  contructor(address _token, address _governance, address _timelock, address _controller)
    public
    ERC20(
  ...
  function balance() public view returns (uint256) {
    return
      token.balance(address(this)).add(
  ...
  //Custom logic in here for how much the jars allow to be borrowed
